...
[AI fill OK] — if skipped, generate: "No animations assumed. Add transitions as needed."
...
[AI fill OK] — if skipped, generate: "No auto-scroll assumed."

### Responsive behaviour (Section D)
[AI fill OK for all responsive questions]
...
[AI fill OK for all animation questions]
...
[AI fill OK for all data questions]
...
[AI fill OK] — if skipped, generate: "Truncate long text with ellipsis. Handle empty states with placeholder."

### Permissions or role-based visibility
> "Does any part of this view look different for different user roles?"
[AI fill OK] — if skipped, generate: "No role-based differences assumed."
